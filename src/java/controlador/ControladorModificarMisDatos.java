 ...
 * @author baggr
 */
@WebServlet(name = "ControladorModificarMisDatos", urlPatterns = {"/ControladorModificarMisDatos"})
public class ControladorModificarMisDatos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.sendRedirect("/MasterBike/MisDatos.jsp");
