...
<html lang="es">
    ...
    <head>
        ...
        <meta charset="UTF-8">
        <title>Reporte de mantención</title>
    ...
    <body class="container-fluid p-5">
        <div class="card-header">
            <a class="btn btn-primary " href="DetalleReportes.jsp">Volver</a>
            <a class="btn btn-success " href="MenuTrabajadores.jsp">ir al menú</a>
            <h2 class="w3-wide w3-center text-center" >Reporte de mantención</h2>
            ...
            <table class="records_list table table-striped table-bordered table-hover" id="mydatatable">
                <thead>
                    <tr>
                        ...
                        <th class="text-center">FECHA FINALIZADA</th>
                        <th class="text-center">RETIRO DOMICILIO</th>
                ...
                <%
                    ...
                    List<Mantencion> venta = dDAO.listarMantencionesWhere();
                ...
                <tbody>
                    <c:forEach var="p" items="${pro}">
                        <tr class="text-center">
                            <td>${p.getIdMantencion()}</td>
                            <td>${p.getFecsalida()}</td>
                            <td>${p.getRetirodomicilio()}</td>
