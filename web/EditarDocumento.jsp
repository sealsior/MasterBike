	...
	<!-- End Header Area -->
        <div class="row">   
            <div class="container mt-2">   
                <form action="ControladorEditarDocumento" class="col-sm-6 offset-sm-3" method="POST">
                    <div class="card card-header ">
                        <div class="card-header text-center" >
                            <h3>EDITAR DOCUMENTO</h3>
                        </div>

                        <input type="hidden" name="txtid" id="txtid" value="${d.getIdDocumentacion()}"/>

                        <div class="card-body">
                            <div class="form-group">
                                <label>Id Producto</label>
                                <input id="txtIdP" type="number" name="txtIdP" class="form-control" min="1" value="${d.getProducto().getIdProducto()}" required="">
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select name="txtTipo" class="form-control"  readonly="readonly" value="${d.getTipodocumento()}" required="" >
                                    <option>PDF</option>                                                                   
                                </select>
                            </div>
                            <br>
                            ...
                            <div class="form-group">
                                ...
                                <input id="txtNombre" type="text" name="txtNombre" class="form-control"  value="${d.getNomdocumento()}" required="" minlength="4" maxlength="16" size="20">
                            </div>
                            <br>
                        ...
                        <div class="card-footer text-center">
                            <input type="submit" name="accion" value="Actualizar" class="btn btn-outline-success" onclick="javascript:if (!confirm('¿Desea actualizar el Documento: ${d.getNomdocumento()}?'))return false"/>
                            <input type="reset" value="Limpiar" class="btn btn-outline-primary"/>
