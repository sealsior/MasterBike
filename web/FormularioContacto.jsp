...
<html>
    ...
    <body>
        ...
        <!--Area formulario-->
        <div class="wrapper">
            <h2 class="form-signin-heading"style="text-align:center">Formulario de contacto ✉</h2>

            <form action="<c:url value="/ControladorContacto" />" class="form-signin" method="post">

                <div class="mb-3 mt-3">
                    <strong for="cboTipo" class="form-label">Motivo:</strong>
                    <select id="cboTipo" name="cboTipo" class="custom-select my-1 mr-sm-2">
                ...
                <div class="mb-3">
                    ...
                    <input type="text"  name="txtNombre" id="txtNombre" class="form-control" placeholder="Ingrese nombre y apellido" required></input>
                    <div class="valid-feedback">Valido.</div>
                    <div class="invalid-feedback">Por favor llene este campo.</div>
                </div>

                <div class="mb-3">
                    <strong for="txtMail" class="form-label" >E-mail:</strong>
                    <input type="email"  name="txtMail" id="txtMail" class="form-control" placeholder="@" required></input>
                    <div class="valid-feedback">Valido.</div>
                    <div class="invalid-feedback">Por favor llene este campo.</div>
                </div>

                <div class="mb-3">
                    <strong for="txtComentario" class="form-label" >Mensaje:</strong>
