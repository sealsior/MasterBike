<%-- 
    Document   : FinalizarSeguimiento
    Created on : 10-11-2021, 22:53:21
    Author     : Marco
--%>
...
<html>
    <head>
        ...
        <title>Finalizar Seguimientos</title>
    </head>
    <body>
        <c:choose>
            <c:when test="${perfil == 4 || perfil == 3 || perfil == 2 || perfil == 5 }">
                ...
                <div class="container mt-4 d-flex">
                    <div class="form-group">
                        <form action="<c:url value="/ControladorAgregarSeguimiento" />" method="post">
                            <div class="card">
                                <div class="card-header">
                                    <h3>Finalizar Envio</h3>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="txtid" id="txtid" value="${s.getIdSeguiEnvios()}" readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4">Codigo Compra</label>
                                        <input type="number" name="txtCodigo" id="txtCodigo" required="true" value="${s.getVenta().getIdVenta()}" readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4">Fecha de despacho</label>
                                        <input type="date" name="txtdespacho" id="txtdespacho" required="true" value="${s.getFecdespacho()}" readonly/>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-sm-4">Estado </label>
                                        <input type="text" name="txtEstado" id="txtEstado" required="true" value="Finalizado" readonly/>
                                    </div>

                                    <div class="card-footer d-flex">
                                        <form action="ControladorAgregarSeguimiento" method="POST">

                                            <input type="submit" name="accion" value="Completar" class="btn btn-success">

                                        </form>

                                        <div class="d-flex">
                                            <a class="btn-danger " href="ListaSeguimiento.jsp">Cancelar</a>
                                        </div>
