<%-- 
    Document   : ExitoSolman
    Created on : 13-10-2021, 18:09:58
    Author     : baggr
--%>
...
<head>
    ...
    <title>Envío de solicitud de mantención exitosa</title>
        </head>
        <body>
        ...
        <h1>Nuestros tecnicos confirmaran su reserva</h1>
        <img src="https://i.ibb.co/CHjTcVv/cleta1.gif" alt="cleta1" border="0">
        <br>
        </div>
