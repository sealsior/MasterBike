<%-- 
    Document   : ListarSolicitudesMantenciones
    Created on : 21-10-2021, 22:52:50
    Author     : baggr
--%>
...
>>>>>>> master
        ...
        <title>Listado de solicitudes de mantencion</title>
    </head>
    <body>
<<<<<<< HEAD
        <c:choose>
            <c:when test="${perfil == 4 || perfil == 3 || perfil == 2 || perfil == 5 }">
                ...
                <div class="container mt-3">     
                    ...
                    <h2>Listado de Solicitudes de Mantención 🛠</h2>
                    <form action="<c:url value="/ControladorListarMantencionesTaller" />" method="post" >
                        <table class="table table-striped" id="table_id">
                            ...
                            <tbody>
                                <%
                                    ...
                                    MantencionDAO mDAO = new MantencionDAO();
                                    List<Mantencion> mantenciones = mDAO.listarMantenciones();
                                    for (Mantencion d : mantenciones) {
                                        out.println("<tr>");
                                        out.println("<td>" + d.getIdMantencion() + "</td>");
                                        out.println("<td>" + d.getRetirodomicilio() + "</td>");
                                        out.println("<td>" + d.getFecSolicitada() + "</td>");
                                        out.println("<td>" + d.getFecingreso() + "</td>");
                                        out.println("<td>" + d.getFecsalida() + "</td>");
                                        out.println("<td>" + d.getComentarios() + "</td>");
                                        out.println("<td>" + d.getServicio().getDescripcionServicio() + "</td>");
                                        out.println("<td>" + d.getServicio().getPrecioservicio() + "</td>");
                                        out.println("<td>" + d.getGarantia() + "</td>");
                                        out.println("<td>" + d.getUsuario().getEmailUsuario() + "</td>");
                                        out.println("<td>" + d.getEstadosolicitud() + "</td>");
                                        out.println("<td><button type='submit' class='btn btn-success' name='accion' value='aprobar-" + d.getIdMantencion() + "' style=';max-width:100%;'>Taller</button></td>");
                                        out.println("</tr>");
...
=======
	...
	<!-- End Header Area -->
        ...
        <div class="container mt-3">     
            <h1>Listado de Solicitudes de reparación - Mantención</h1>
