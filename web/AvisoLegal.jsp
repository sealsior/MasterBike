<%-- 
    Document   : AvisoLegal
    Created on : 25-10-2021, 18:19:14
    Author     : baggr
--%>
   ...
   <meta charset="utf-8" />
    ...
    <body>
        ...
        <div class="container">
            <h1>AVISO LEGAL</h1>
            <p>
                El uso de esta tienda online se rige por los términos y condiciones descritos a continuación, así como por la legislación que se aplique en la República de Chile. En consecuencia, todas las visitas, como asimismo sus efectos jurídicos, quedarán regidos por estas reglas y sometidas a esa legislación. Los términos y condiciones contenidos en este instrumento se aplicarán y se entenderán formar parte de todos los actos y contratos que se ejecuten o celebren mediante los sistemas de oferta y comercialización comprendidos en este sitio web entre los usuarios de este sitio y Bicicletas Masterbike Limitada.<br>
...
8. El presente sitio Web podrá ser suprimido en cualquier momento y la información aquí difundida podrá ser objeto de modificación total o parcial en cualquier forma por Bicicletas Masterbike.<br>
