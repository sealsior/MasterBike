                        ...
                        <c:forEach var="p" items="${pro}">
                            <tr class="text-center">
                                ...
                                <td class="d-flex">
                                    ...
                                    <a href="ControladorProducto?accion=eliminar&id=${p.getIdProducto()}" class="btn btn-danger" onclick="javascript:if(!confirm('¿Desea eliminar el producto ${p.getNombreproducto()}?${p.getIdProducto()}'))return false">Eliminar</a>
