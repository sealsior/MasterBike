...
<<<<<<< HEAD
    ...
    <body >
        ...
        <div class="card-header">
            ...
            <h2 class="w3-wide w3-center text-center" >Reportes</h2>
            ...
            <table class="records_list table table-striped table-bordered table-hover" id="mydatatable">
                ...
                <tbody>
                    ...
                    <c:forEach var="p" items="${pro}">
                        <c:set var="Total" value="${Total + p.getTotalventa()}" />
                    ...
                    Total Historico $.${pro.stream().map(p -> p.getTotalventa()).sum()}
        ...
        <table class="records_list table table-striped table-bordered table-hover" id="mydatatable">
            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td>${p.getFechora()}</td>
                    <td>$.${p.getTotalventa()}</td>
                    <td>${p.getUsuario().getPnombre()} ${p.getUsuario().getAppaterno()}</td>
                    <td>${p.getEstadoventa()}</td>
