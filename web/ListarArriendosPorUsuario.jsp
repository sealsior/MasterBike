...
>>>>>>> master
<%-- 
    Document   : ListarArriendosPorUsuario
    Created on : 02-11-2021, 14:15:27
    Author     : baggr
--%>
...
<<<<<<< HEAD
        ...
        <div class="container">     
        <h1>Mis arriendos 📋</h1>
        <form action="<c:url value="/ControladorContrato" />" method="post" target="_blank">
=======
...
>>>>>>> master
            ...
            <tbody>
                <%
                            ...
                            List<Solicitudarriendo> arriendos = solarrDAO.buscarArriendosPorUsuario(user);
...
<<<<<<< HEAD
                                ...
                                out.println("<td><button type='submit' class='btn btn-primary' name='accion' value='aprobar-" + d.getIdSolArriendo() + "' style=';max-width:100%;'>Ver</button></td>");
=======
                                out.println("<td>" + d.getComentario() + "</td>");
