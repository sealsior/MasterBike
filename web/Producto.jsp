...
<<<<<<< HEAD
      ...
      <div class="form-group">
        <form action="<c:url value="/ControladorProducto" />" method="post" enctype="multipart/form-data">
=======
	...
	<!-- End Header Area -->
      ...
      <div class="container mt-4 d-flex">
      <div class="form-group">
        <form action="<c:url value="/ControladorProducto" />" method="post">
>>>>>>> master
            <div class="card">
...
<<<<<<< HEAD
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="txtDescripcion" id="txtDescripcion" required="true" rows="5" cols="20"></textarea>
                        </div>
                      <div class="form-group">
...
=======
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="txtDescripcion" id="txtDescripcion" required="true"/>
                        </div>
                      <div class="form-group">
                            <label class="col-sm-4">Proveedor</label>
...
>>>>>>> master
                      ...
                      <div class="form-group">
                            ...
                            <input type="number" name="txtValor" id="txtValor" min="1" required="true"/>
                      </div>
                      <div class="form-group">
                            <label class="col-sm-4">Marca</label>
                            <input type="text" name="txtMarca" id="txtMarca" required="true"/>
                      </div>
                      <div class="form-group">
                            <label class="col-sm-4">Modelo</label>
                            <input type="text" name="txtModelo" id="txtModelo" required="true"/>
                      </div>
                      <div class="form-group">
                            <label class="col-sm-4">Stock</label>
                            <input type="number" name="txtStock" id="txtStock" min="0" required="true"/>
                      </div>
                      <div class="form-group">
<<<<<<< HEAD
                            <input type="file" name="fileImagen" id="fileImagen" required="true">
=======
                            <label class="col-sm-4">Imagen</label>
