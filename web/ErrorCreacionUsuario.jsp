<%-- 
    Document   : ErrorCreacionUsuario
    Created on : 11-12-2021, 0:24:02
    Author     : baggr
--%>
...
<!DOCTYPE html>
    <html>
        <head>
            ...
            <meta http-equiv="Refresh" content="3;URL=ListarUsuarios.jsp">
     ...
     <script src="https://kit.fontawesome.com/c747d09760.js" crossorigin="anonymous"></script>
        ...
        .container {
            ...
            <title>Error creación usuario</title>
        </head>
        <body>
        ...
        <h2>El e-mail ingresado ya está registrado, intente con otro!</h2>
        </div>
    ...
    <section class="">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="list-unstyled mb-0">
            <li>
              <a href="RegistroUsuario.jsp" class="text-white">Registrate</a>
            </li>
            <li>
              <a href="Login.jsp" class="text-white">Iniciar sesión</a>
            </li>
            <li>
              <a href="Login.jsp" class="text-white">Seguimiento de envios</a>
            </li>
            </ul>
        </div>
        <!--Grid column-->
