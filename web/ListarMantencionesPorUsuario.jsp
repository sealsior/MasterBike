<%-- 
    Document   : ListarMantencionesPorUsuario
    Created on : 02-11-2021, 13:23:44
    Author     : baggr
--%>
                        ...
                        <table class="table table-striped" id="table_id">
                            ...
                            <tbody>
                                <%
                                    ...
                                    List<Mantencion> mantenciones = mDAO.buscarMantencionesPorUsuario(user);
...
=======
	...
	<!-- End Header Area -->
        <div class="container mt-3">     
            <h1>Mis solicitudes de mantención</h1>
