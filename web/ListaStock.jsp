    ...
    <head>
        ...
        <style>
            ...
            .modal-header.login-header {
                ...
                <title>Lista stock de productos</title>
            </head>
                            ...
                            <div class="container-fluid display-table">
                                <div class="row display-table-row">
                                            ...
                                            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                                                ...
                                                <div class="navi">
                                                    <ul>
                                                        ...
                                                        <li class="active"><a href="ListaStock.jsp"><i class="fab fa-stack-exchange" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Stock</span></a></li>
                                            ...
                                            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                                                ...
                                                <div class="navi">
                                                    <ul>
                                                        ...
                                                        <li><a href="ReporteVenta.jsp"><i class="far fa-chart-bar" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Reportes de venta</span></a></li>
                                                        <li><a href="EnviarPromocion.jsp"><i class="fas fa-envelope-square" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Enviar Promociones</span></a></li>
                                                        <li><a href="MisDatos.jsp"><i class="fa fa-cog" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Configuración</span></a></li>
                                                    </ul>
                                                </div>
                                    ...
                                    <div class="container" style="">
                                        <h2 class="w3-wide w3-center text-center" >Lista stock de productos</h2>
