<%-- 
    Document   : CondicionesArriendo
    Created on : 14-11-2021, 19:48:20
    Author     : baggr
--%>
...
<html>
   ...
   <meta charset="utf-8" />
    ...
    <body>
        ...
        <br>
        <div class="container">
            <h1>TÉRMINOS Y CONDICIONES DE ARRIENDO</h1>
            <p>
       
1. El alquiler de bicicletas implica la aceptación de estas condiciones por parte del
arrendador y arrendatario.
<br>
2. El arrendatario y el arrendador están obligados a comprobar a la llegada de la bicicleta si hay daños en ésta para saber si se ha
hecho un buen uso de la bicicleta. 
<br>
3. El arrendatario es responsable de la bicicleta durante todo el período del contrato
de alquiler de la bicicleta y responsable de los daños a la propiedad alquilada. 
<br>
4. El arrendador no será responsable del arrendatario, ni de los daños a terceros que
el arrendatario pudiera ocasionar, se puede contratar un seguro de
responsabilidad civil.
<br>
5. La contratación de un seguro de accidentes es
opcional por parte del arrendatario.
<br>
6. En caso de rotura, el arrendatario deberá pagar las reparaciones necesarias para su regreso al servicio.
<br>
7. En caso de robo, el arrendatario deberá pagar el valor comercial fijado por Masterbike.
<br>
8. El arrendatario será responsable de cumplir con la normativa del Ministerio del Transporte. (le recordamos que el uso del casco
es obligatorio siempre).
<br>
9. El arrendatario entrega una garantia de un porcentaje del arriendo y será devuelto a la entrega y tras revisión de la bicicleta.
<br>
10. La bicicleta se entrega en perfecto estado y tras haber sido revisada por el
propietario y el arrendador anotando los desperfectos en caso de que hubiera
alguno.
            </p>
        </div>
        <br>
