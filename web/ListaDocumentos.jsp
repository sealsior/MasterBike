<%-- 
    ...
    Created on : 18-11-2021, 19:17:05
    Author     : Marco
--%>
                                    ...
                                    <c:choose> 
                                            ...
                                            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                                                ...
                                                <div class="navi">
                                                    <ul>
                                                        ...
                                                        <li><a href="MisDatos.jsp"><i class="fa fa-cog" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Configuración</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                                                ...
                                                <div class="navi">
                                                    <ul>
                                                        ...
                                                        <li><a href="ListaStock.jsp"><i class="fab fa-stack-exchange" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Stock</span></a></li>
                                                        <li class="active"><a href="ListaDocumentos.jsp"><i class="fas fa-file-pdf" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Documentos</span></a></li>
                                                        <li><a href="MisDatos.jsp"><i class="fa fa-cog" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Configuración</span></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <c:when test="${perfil == 4}"><!--Rol 4 Supervisor -->
                                            ...
                                            <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                                                ...
                                                <div class="navi">
                                                    <ul>
                                                        <li class="active"><a href="MenuTrabajadores.jsp"><i class="fa fa-home" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Inicio</span></a></li>
                                                        <li><a href="ControladorMantencion"><i class="fas fa-hammer" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Solicitud Taller</span></a></li>
                                                        <li><a href="ControladorTaller"><i class="fas fa-hammer" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Taller</span></a></li>
                                                        <li><a href="SolicitudArriendo.jsp"><i class="fa fa-calendar" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Solicitud Arriendos</span></a></li>
                                                        ...
                                                        <li><a href="ReporteVenta.jsp"><i class="fas fa-clipboard-check" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Reportes de venta</span></a></li>
                                    ...
                                    <div class="container">
                                        <table class="table table-bordered table-striped" id="table_id">
                                            <div class="card-header">
                                                ...
                                                <h2 class="w3-wide w3-center text-center" >Lista de Documentos</h2>
                                            ...
                                            <%
                                                ...
                                                DocumentacionDAO pDAO = new DocumentacionDAO();
                                                List<Documentacion> productos = pDAO.listarDocumentacion();
                                                request.setAttribute("pro", productos);
                                            %>
                                            <tbody id="myTable">
                                                <c:forEach var="p" items="${pro}">
                                                    <tr class="text-center">
                                                        <td>${p.getIdDocumentacion()}</td>
                                                        <td>${p.getNomdocumento()}</td>
                                                        <td>${p.getTipodocumento()}</td>
                                                        <td>${p.getProducto().getNombreproducto()}</td>
                                                        <td><img src="${p.getProducto().getImagen()}" height="100" width="100"></td>
                                                        <td>
                                                            <a href="${p.getDocumento()}">Descargar</a>
                                                        </td>
                                                        <td class="d-flex">

                                                            <a href="ControladorDocumentos?accion=eliminar&id=${p.getIdDocumentacion()}" class="btn btn-danger" onclick="javascript:if (!confirm('¿Desea eliminar el documento ${p.getNomdocumento()}?'))
