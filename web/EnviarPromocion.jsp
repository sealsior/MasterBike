<%-- 
    Document   : EnviarPromocion
    Created on : 09-12-2021, 16:50:03
    Author     : baggr
--%>
<%-- 
    Document   : FormularioContacto
    Created on : 09-12-2021, 13:30:41
    Author     : baggr
--%>
    ...
    <head>
        ...
        <style>
            ...
            .modal-header.login-header {
                ...
                <title>Envio de promociones</title>
            </head>
            <body>
                <c:choose>
                    ...
                    <div class="container-fluid display-table">
                        <div class="row display-table-row">
                                    ...
                                    <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
                                        ...
                                        <div class="navi">
                                            <ul>
                                                ...
                                                <li class="active"><a href="EnviarPromocion.jsp"><i class="fas fa-envelope-square" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Enviar Promociones</span></a></li>
                            ...
                            <div class="container">
                                ...
                                <!--Area formulario-->
                                <div class="wrapper">
                                    <h2 class="form-signin-heading"style="text-align:center">Enviar promociones masivas🤑</h2>
                                    <form action="<c:url value="/ControladorPromociones" />" class="form-signin" method="post">

                                        <div class="mb-3">
                                            <strong for="cboTipoCliente" class="form-label">Clientes objetivo:</strong>
                                            <select name="cboTipoCliente" id="cboTipoCliente" class="custom-select my-1 mr-sm-2">
                                        ...
                                        <div class="mb-3">
                                            <strong for="txtDetalle" class="form-label" >Detalle de la promoción:</strong>
                                            <textarea  name="txtDetalle" id="txtDetalle" class="form-control" placeholder="Ingrese contenido" required maxlength="500" rows="10"></textarea>
                                            <div class="valid-feedback">Valido.</div>
                                            <div class="invalid-feedback">Por favor llene este campo.</div>
                                        </div>

                                        <button type="submit" class="btn btn-primary" onclick="javascript:if (!confirm('¿Desea enviar la promoción?'))
                        return false">Enviar promoción</button>
                                        <br>    
                                        <br>
