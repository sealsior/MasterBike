...
View Compiled
    ...
    <body>
        ...
        <form action="<c:url value="/ControladorCrearUsuario" />" class="form-signin" method="post">
            ...
            <input type="password" name="txtPassword" id="txtPassword"  class="form-control" minlength="8"  placeholder="Ingresar contraseña" required="" />
            ...
            <input type="number" name="txtNumtelefono" id="txtNumtelefono" class="form-control" placeholder="55-5-55555555" required/>
            <div class="valid-feedback">Válido.</div>
            <div class="invalid-feedback">Por favor, llene este campo.</div>
            </div>
            <div class="mb-3">
            <strong for="cboConvenio" class="form-label">Convenio:</strong>
            <select name="cboConvenio" id="cboConvenio" class="custom-select my-1 mr-sm-2">
