...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="https://i.ibb.co/T04Jq4S/carr2.jpg" alt="Pexels"  class="rounded mx-auto d-block"/>
      <div class="carousel-caption d-none d-md-block">
        <h5>Fanático del Downhill? </h5>
        <p>Temenos las mejores bicicletas con doble suspensión.</p>
      </div>
    </div>
    <div class="carousel-item">
        <img src="https://fondosmil.com/fondo/59384.jpg" alt="Salto" width="640px" height="426px" class="rounded mx-auto d-block">
        <div class="carousel-caption d-none d-md-block">
        <h5>Convenios con empresas y municipios</h5>
        <p>Registrate para obtener beneficios.</p>
      </div>
    </div>
    <div class="carousel-item">
      <img src="https://fondosmil.com/fondo/59285.jpg" width="640px" height="426px" alt="Pista"  class="rounded mx-auto d-block">
      <div class="carousel-caption d-none d-md-block">
        <h5>Taller de reparaciones</h5>
        <p>Realiza las mantenciones de tu bicicleta en nuestro workshop MB.</p>
      </div>
    </div>
  </div>
    ...
    <section class="">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="list-unstyled mb-0">
            <li>
              <a href="mailto:info@masterbike.cl" class="text-white">Contáctanos</a>
            </li>
            <li>
