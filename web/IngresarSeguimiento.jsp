<%-- 
    Document   : IngresarSeguimiento
    Created on : 08-11-2021, 18:23:45
    Author     : Marco
--%>
                        ...
                        <form action="<c:url value="/ControladorAgregarSeguimiento" />" method="post">
                            <div class="card">
                                ...
                                <div class="card-header">
                                    <h3>Ingresar Envio</h3>
                                </div>

                                <input type="hidden" name="txtidventa2" id="txtidventa2" value="${producto.getIdVenta()}" readonly/>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label class="col-sm-4">ID</label>
                                        <input type="number" name="txtid" id="txtid" value="${producto.getIdVenta()}" readonly/>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-4">Codigo Compra</label>
                                        <input type="number" name="txtCodigo" id="txtCodigo" required="true" value="${producto.getIdVenta()}" readonly/>
                                    </div>


                                    <div class="form-group">
                                        <label class="col-sm-4">Estado </label>
                                        <input type="text" name="txtEstado" id="txtEstado" required="true" value="En Camino" readonly/>
                                    </div>
                                    ...
                                    <div class="card-footer d-flex">
                                        ...
                                        <div class="d-flex">
                                            <a class="btn btn-danger " href="EnviarSeguimiento.jsp">Cancelar</a>
                                        </div>
